            ...
            <div class="container">
                <div class="sec-title">
                    ...
                    <div class="award-wrap scroll-cont row">
                        <div class="col-lg-2 col"><img decoding="async" src="<?php echo MANAGTRIX_DIR_URI . '/assets/images/award/award-1.svg'?>" alt=""
                                class="img-fluid"></div>
                        <div class="col-lg-2 col"><img decoding="async" src="<?php echo MANAGTRIX_DIR_URI . '/assets/images/award/award-2.svg'?>" alt=""
                                class="img-fluid"></div>
                        <div class="col-lg-2 col"><img decoding="async" src="<?php echo MANAGTRIX_DIR_URI . '/assets/images/award/award-3.svg'?>" alt=""
                                class="img-fluid"></div>
                        <div class="col-lg-2 col"><img decoding="async" src="<?php echo MANAGTRIX_DIR_URI . '/assets/images/award/award-4.svg'?>" alt=""
                                class="img-fluid"></div>
                        <div class="col-lg-2 col"><img decoding="async" src="<?php echo MANAGTRIX_DIR_URI . '/assets/images/award/award-5.svg'?>" alt=""
                                class="img-fluid"></div>
                        <div class="col-lg-2 col"><img decoding="async" src="<?php echo MANAGTRIX_DIR_URI . '/assets/images/award/award-6.svg'?>" alt=""
                                class="img-fluid"></div>
                    </div>
                                ...
                                <div class="box flex">
                                    <div class="thum-svg">
                                        <svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                                            ...
                                            <path
                                                d="m24.812 28.676 3.864-8.695a2.9 2.9 0 0 1 2.898 2.898v3.865h5.468a1.933 1.933 0 0 1 1.932 2.222L37.64 37.66a1.93 1.93 0 0 1-1.932 1.642H24.81m0-10.626v10.626m0-10.626h-2.898a1.93 1.93 0 0 0-1.932 1.932v6.762a1.93 1.93 0 0 0 1.932 1.932h2.898"
                                                stroke="#009A77" stroke-width="1.932" stroke-linecap="round"
                        ...
                        <div class="grid-2">
                            <div class="mg-flip-card">
                                <div class="img-placeholder">
                                    <a href="#">
                                        <img src="https://ityug247.com/wp-content/uploads/2023/09/social-media-and-e-commerce.webp"
                                            alt="" class="img-fluid">
                                    </a>
                                </div>
                                <div class="mg-card-content">
                                    <a href="#" class="category">blog</a>
                                    <a href="#" class="blog-title">Here are 15 Sure-Shot Ways to Fix “Netflix Error
                                        Code</a>
                                    <hr>
                                    <div class="timeline"> 14 Feb, 2024 <span>/</span> By <a href="#">Anna Rosé</a>
                                    </div>
                                </div>
                            </div>
                            <div class="mg-flip-card">
